            ...
            <div className="row">
              <div className="product-details col-md-4 mb-2">
                ...
                <select name='warranty' id='' value={formData.warranty} className='form-control' onChange={handleChange} >
                  ...
                  <option value="2 Months">4 Months</option>
                  <option value="2 Months">5 Months</option>
                  <option value="2 Months">6 Months</option>
                  <option value="2 Months">7 Months</option>
                  <option value="2 Months">8 Months</option>
                  <option value="2 Months">9 Months</option>
                  <option value="2 Months">10 Months</option>
                  <option value="2 Months">11 Months</option>
                  <option value="2 Months">12 Months</option>
                  <option value="2 Months">13 Months</option>
                  <option value="2 Months">14 Months</option>
                  <option value="2 Months">15 Months</option>
                  <option value="2 Months">16 Months</option>
                  <option value="2 Months">17 Months</option>
                  <option value="2 Months">18 Months</option>
                  <option value="2 Months">19 Months</option>
                  <option value="2 Months">20 Months</option>
                  <option value="2 Months">21 Months</option>
                  <option value="2 Months">22 Months</option>
                  <option value="2 Months">23 Months</option>
                  <option value="2 Months">24 Months</option>
                  <option value="2 Months">25 Months</option>
                  <option value="2 Months">26 Months</option>
                  <option value="2 Months">27 Months</option>
                  <option value="2 Months">28 Months</option>
                  <option value="2 Months">29 Months</option>
                  <option value="2 Months">30 Months</option>
                  <option value="2 Months">31 Months</option>
                  <option value="2 Months">32 Months</option>
                  <option value="2 Months">33 Months</option>
                  <option value="2 Months">34 Months</option>
                  <option value="2 Months">35 Months</option>
                  <option value="2 Months">36 Months</option>
                </select>
              </div>
              <div className="product-details col-md-4 mb-2">
