...
CREATE TABLE IF NOT EXISTS `posSystem`.`rentalInvoice` (
  ...
  `products_productId` INT NOT NULL,
  `products_category_categoryId` INT NOT NULL,
  PRIMARY KEY (`rentalInvoiceId`, `customer_cusId`, `products_productId`, `products_category_categoryId`),
  INDEX `fk_rentalInvoice_customer1_idx` (`customer_cusId` ASC),
  INDEX `fk_rentalInvoice_products1_idx` (`products_productId` ASC, `products_category_categoryId` ASC),
